...
return {
  ...
  config = function()
    ...
    local function toggle_file_dir_terminal()
      ...
      -- Save the current file if it’s a writable file buffer

      if vim.fn.expand("%") ~= "" and vim.api.nvim_buf_get_option(0, "buftype") == "" and vim.api.nvim_buf_get_option(0, "modified") then
